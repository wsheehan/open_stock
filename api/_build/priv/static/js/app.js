...
var username = "eada4ad55493b61365859339c4c383d3"; // To use Phoenix channels, the first step is to import Socket
// and connect at the socket path in "lib/my_app/endpoint.ex":

var password = "4de15d2c4757c9eb733300e8c3691c36";
...
$.ajax({
  ...
  error: function error(xhr, status, _error) {
    console.error("Error connecting: ", _error);
  }
});
...
var connect = function connect(token) {
  var socket = new _phoenix.Socket(socket_url, { params: { token: token } });
  socket.connect();
...
var startListening = function startListening() {
  var channel = connectedSocket.channel("iex:securities:" + ticker, {});
  ...
  channel.on("quote", function (msg) {
    console.log(msg);
    if (msg.type === "ask") {
      $("#" + ticker + "-price").text(msg.price);
    }
  });

  // Heart Beat Message
  setInterval(function () {
    var hearbeat_channel = socket.channel("phoenix", { "event": "heartbeat", "payload": {}, "ref": null });
  }, 20000);
};
